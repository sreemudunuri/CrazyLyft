...
bloodImg.src = "assets/blood_EW.png"
var car = new Image();
...
function startGame() {
    ...
    newPassangersArray.push(new sprite({
        x: 30,
        y: 100,
...
function sprite(options) {
    ...
    that.x = options.x;
    that.y = options.y
    passangersArray.push(new passanger(30, 30, that.x, that.y))
...
function passanger(width, height, x, y) {
    this.width = width;
    this.height = height;
    this.x = x;
    this.y = y;
